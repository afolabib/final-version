...
function buildSoulContent(agentType, operatorName, businessSummary, tone, autonomy, priority, channel) {
    const souls = {
...
function buildBootstrap(agentType, operatorName, businessSummary) {
    const roleSteps = {
...
function generateOpenClawWorkspace(profile) {
    ...
    const files = [
        ...
        },
        {
            ...
            content: buildSoulContent(profile.agent.type, operatorName, businessSummary, tone, profile.agent.autonomy || '', profile.agent.priority || '', profile.agent.communicationChannel || ''),
        },
        {
            path: 'USER.md',
