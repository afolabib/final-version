      ...
      <motion.div style={{ y: yText, opacity, scale }} className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        >
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
            ...
            onMouseEnter={e => e.currentTarget.style.boxShadow = '0 12px 36px rgba(91,95,255,0.45)'}
            onMouseLeave={e => e.currentTarget.style.boxShadow = '0 8px 24px rgba(91,95,255,0.35)'}>
            Launch Freemi →
          </motion.button>
        </motion.div>
