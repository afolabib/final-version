...
const capabilities = [
  { icon: Mail, title: 'Email Triage', desc: 'Reads, classifies, and responds to emails before you even open your inbox.', color: '#5B5FFF' },
  ...
  { icon: Calendar, title: 'Smart Scheduling', desc: 'Coordinates meetings across time zones — zero back-and-forth.', color: '#5B5FFF' },
  ...
  { icon: BarChart3, title: 'Reporting & Insights', desc: 'Synthesizes data from your tools into daily briefings and dashboards.', color: '#5B5FFF' },
...
export default function AboutCapabilities() {
  return (
    <section className="py-12 md:py-20 px-4 md:px-6 relative">
      <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(91,95,255,0.04), transparent 60%)' }} />
      ...
      <div className="max-w-5xl mx-auto relative">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight mb-3 md:mb-4" style={{ color: '#0A0A1A', letterSpacing: '-0.02em' }}>
            ...
            <span style={{ color: '#5B5FFF' }}>An operator.</span>
          </h2>
