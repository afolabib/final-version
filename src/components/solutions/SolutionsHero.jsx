...
export default function SolutionsHero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-28 md:pt-36 pb-16 md:pb-24 px-4 md:px-6 overflow-hidden">
      {/* Background orbs */}
      <div className="absolute top-20 left-[10%] w-72 h-72 rounded-full blur-3xl pointer-events-none" style={{ background: 'rgba(123,97,255,0.06)' }} />
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
          ...
          One Platform.{' '}
          <span style={{
            background: 'linear-gradient(135deg, #7B61FF, #E84393)',
        ...
        <motion.p initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.75 }}
          ...
          Deploy AI employees that handle sales, support, ops, success, executive tasks, and research — working 24/7 so your team can focus on what actually moves the needle.
        </motion.p>
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}
          ...
          <Link to="/dashboard"
            ...
            style={{ background: 'linear-gradient(135deg, #7B61FF, #7C6CF7)', boxShadow: '0 8px 24px rgba(123,97,255,0.35)' }}>
