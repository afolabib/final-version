            ...
            <div className="text-center px-8 py-10 md:px-12 md:py-12 rounded-[1.5rem] relative overflow-hidden"
              ...
              <div className="relative z-10">
                ...
                <motion.div
                  ...
                  <button onClick={() => window.open('https://studio.freemi.ai', '_blank')} className="px-8 py-3 rounded-full bg-white text-[#1F2937] font-bold text-sm transition-all shadow-lg hover:shadow-xl hover:scale-105">
                    Start free trial →
                  </button>
                  <a href="/for-business"
