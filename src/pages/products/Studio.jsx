      ...
      <section className="py-20 px-6">
        <ScrollReveal>
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10"><h3 className="text-2xl font-extrabold text-surface">Simple pricing</h3></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {/* Fixed price */}
              <div className="rounded-2xl p-8 text-left relative" style={{ background: 'rgba(255,255,255,0.95)', border: '2px solid rgba(123,97,255,0.2)', boxShadow: '0 16px 48px rgba(123,97,255,0.1)' }}>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-1">Standard</p>
                <div className="flex items-baseline gap-2 mt-2"><span className="text-lg text-gray-300 line-through">€1,500</span></div>
                ...
                <p className="text-xs text-gray-400 mt-2 mb-6">Website + AI + hosting. Everything included.</p>
                <div className="space-y-2.5">
                  {['Professional custom website', 'AI concierge embedded', 'Bookings & lead capture', 'Full analytics dashboard', 'Hosting & management included', 'Mobile responsive & SEO'].map(f => (
              ...
              {/* Custom */}
              <div className="rounded-2xl p-8 text-left" style={{ background: 'rgba(255,255,255,0.85)', border: '1px solid rgba(0,0,0,0.06)' }}>
                ...
                <p className="text-xs text-gray-400 mt-2 mb-6">For bigger projects and enterprise needs.</p>
                <div className="space-y-2.5">
                  {['Everything in Standard', 'Multi-page websites', 'E-commerce integration', 'Custom AI training', 'Priority support', 'Dedicated account manager'].map(f => (
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="mt-6">
                  <a href="mailto:hello@freemi.ai" className="block w-full py-3.5 rounded-full text-center font-bold text-sm" style={{ border: '1px solid rgba(0,0,0,0.1)', color: '#374151' }}>Get a quote →</a>
                </motion.div>
              </div>
            </div>
          </div>
