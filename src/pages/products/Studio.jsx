        ...
        <ScrollReveal>
          <div className="max-w-lg mx-auto">
            <div className="rounded-3xl p-10 text-center relative overflow-hidden"
              ...
              <h3 className="text-2xl font-extrabold text-surface">Custom pricing</h3>
              <div className="mt-4 flex items-baseline justify-center gap-1.5">
                <span className="text-5xl font-extrabold text-surface">Custom</span>
              </div>
              <p className="mt-3 text-sm text-gray-400 max-w-sm mx-auto">Every project is different. We'll scope your site, configure your AI, and give you a fixed quote — no surprises.</p>
              <div className="mt-8 space-y-3 text-left">
                {['Professional custom website', 'AI concierge embedded & configured', 'Bookings, leads & enquiry handling', 'Full analytics dashboard', 'Ongoing hosting & management', 'Connected to your tools', 'Mobile responsive & SEO optimised', 'Dedicated account manager'].map(f => (
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="mt-8">
                <a href="mailto:hello@freemi.ai" className="block w-full py-4 rounded-full text-center text-white font-bold text-base relative overflow-hidden group" style={{ background: 'linear-gradient(135deg, #7B61FF, #6C4AE8)', boxShadow: '0 8px 24px rgba(123,97,255,0.3)' }}>
