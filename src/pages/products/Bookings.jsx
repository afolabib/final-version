        ...
        <ScrollReveal delay={0.1}>
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="rounded-2xl p-7 text-left relative" style={{ background: 'rgba(255,255,255,0.95)', border: `2px solid #F59E0B30`, boxShadow: `0 16px 48px #F59E0B12`, transform: 'scale(1.02)' }}>
              ...
              <div className="flex items-baseline gap-1 mt-2"><span className="text-3xl font-extrabold" style={{ color: '#F59E0B' }}>€39.99</span><span className="text-gray-400 text-sm">/month</span></div>
            ...
            <div className="rounded-2xl p-7 text-left" style={{ background: 'rgba(255,255,255,0.85)', border: '1px solid rgba(0,0,0,0.06)' }}>
              ...
              <div className="flex items-baseline gap-1 mt-2"><span className="text-3xl font-extrabold text-surface">€59.99</span><span className="text-gray-400 text-sm">/month</span></div>
