                  ...
                  <div className="px-6 py-6 text-center">
                    ...
                    <div className="flex justify-center mb-4">
                      <motion.div
                        ...
                        style={{ background: 'linear-gradient(135deg, #7B61FF, #6C4AE8)', boxShadow: '0 8px 32px rgba(123,97,255,0.5)' }}>
                        {/* Sound waves */}
                        {[1, 2, 3].map(n => (
                          <motion.div key={n}
                            className="absolute rounded-2xl"
                            style={{ inset: -n * 8, border: `1px solid rgba(123,97,255,${0.3 / n})` }}
            ...
            {useCases.map((uc, i) => (
              <ScrollReveal key={uc.industry} delay={i * 0.05}>
                <div className="rounded-2xl overflow-hidden"
                  style={{ border: '1px solid rgba(123,97,255,0.08)', background: '#FAFBFF' }}>
                    ...
                    <div className="p-8 md:border-r" style={{ borderColor: 'rgba(123,97,255,0.06)' }}>
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-semibold" style={{ color: '#7B61FF' }}>{uc.headline}</p>
                        </div>
                      </div>
                        ...
                        {uc.example.map((line, j) => (
                          <div key={j} className={`flex ${line.side === 'caller' ? 'justify-end' : 'justify-start'} items-start gap-2`}>
                            ...
                            <div className={`max-w-[85%] px-3.5 py-2.5 rounded-2xl text-xs leading-relaxed`}
                              style={{
                                background: line.side === 'freemi' ? 'rgba(123,97,255,0.08)' : 'rgba(0,0,0,0.04)',
                                color: '#374151',
                                borderRadius: line.side === 'freemi' ? '12px 12px 12px 3px' : '12px 12px 3px 12px',
                                border: line.side === 'freemi' ? '1px solid rgba(123,97,255,0.1)' : 'none',
                              }}>
                              <span className="text-[8px] font-bold uppercase tracking-wider block mb-1"
                                style={{ color: line.side === 'freemi' ? '#7B61FF' : '#94A3B8' }}>
            ...
            {features.map((f, i) => (
              <ScrollReveal key={f.title} delay={i * 0.07}>
                <div className="p-6 rounded-2xl h-full"
                  style={{ border: '1px solid rgba(123,97,255,0.08)', background: 'rgba(255,255,255,0.85)', boxShadow: '0 2px 12px rgba(0,0,0,0.03)' }}>
            ...
            {faqs.map((faq, i) => (
              <ScrollReveal key={faq.q} delay={i * 0.04}>
                <div className="p-5 rounded-2xl"
                  style={{ background: 'white', border: '1px solid rgba(123,97,255,0.08)', boxShadow: '0 2px 8px rgba(0,0,0,0.03)' }}>
