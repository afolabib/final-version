    ...
    <div className="relative w-full" style={{ background: 'linear-gradient(135deg, #F5F3FF 0%, #F8F9FE 50%, #F0F1FF 100%)', minHeight: '100vh' }}>
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse 800px 500px at 50% 0%, rgba(123,97,255,0.06), transparent)' }} />
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }}
              className="relative">
              {/* Browser chrome */}
              <div className="rounded-2xl overflow-hidden" style={{ boxShadow: '0 24px 60px rgba(0,0,0,0.15)', border: '1px solid rgba(123,97,255,0.1)' }}>
                {/* Browser bar */}
                ...
                <div className="relative" style={{ background: '#FFFFFF', minHeight: 380 }}>
                  ...
                  <div className="px-5 py-3 flex items-center justify-between" style={{ borderBottom: '1px solid #F3F4F6' }}>
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-md" style={{ background: '#7B61FF' }} />
                  ...
                  <div className="px-6 py-8">
                    ...
                    <div className="w-24 h-7 rounded-full" style={{ background: 'rgba(123,97,255,0.12)' }} />
                  </div>
                  {/* Fake services row */}
                  ...
                  <div className="absolute bottom-4 right-4 flex flex-col items-end gap-2">
                    ...
                    <motion.div
                      ...
                      style={{ background: 'white', color: '#7B61FF', border: '1px solid rgba(123,97,255,0.15)', boxShadow: '0 4px 16px rgba(123,97,255,0.12)', whiteSpace: 'nowrap' }}>
                      Hi! Can I help? 👋
                      <div className="absolute -bottom-1 right-5 w-2 h-2 rotate-45" style={{ background: 'white', borderRight: '1px solid rgba(123,97,255,0.15)', borderBottom: '1px solid rgba(123,97,255,0.15)' }} />
                    </motion.div>
              ...
              <motion.div
                ...
                <div className="px-3 py-2.5 flex items-center gap-2" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(255,255,255,0.03)' }}>
                  <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #7B61FF, #6C4AE8)' }}>
                  ...
                  {chatMessages.slice(0, 4).map((m, i) => (
                    <div key={i} className={`flex ${m.side === 'user' ? 'justify-end' : 'justify-start'}`}>
                      <div className="max-w-[85%] px-2.5 py-1.5 rounded-lg text-[9px] leading-relaxed"
                        style={{
                          background: m.side === 'bot' ? 'rgba(123,97,255,0.2)' : 'rgba(255,255,255,0.07)',
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {features.map((f, i) => (
              <ScrollReveal key={f.title} delay={i * 0.07}>
                <div className="p-6 rounded-2xl h-full" style={{ border: '1px solid rgba(123,97,255,0.08)', background: '#FAFBFF' }}>
            ...
            {useCases.map((uc, i) => (
              <ScrollReveal key={uc.industry} delay={i * 0.06}>
                <div className="p-5 rounded-2xl"
                  style={{ background: 'rgba(255,255,255,0.85)', border: '1px solid rgba(123,97,255,0.07)', boxShadow: '0 2px 12px rgba(0,0,0,0.03)' }}>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <ScrollReveal>
            ...
            <div className="rounded-xl p-5 text-left text-xs font-mono mb-4"
              style={{ background: '#0A0F1E', color: '#A5B4FC', border: '1px solid rgba(123,97,255,0.15)' }}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-sm mx-auto text-center">
          <ScrollReveal>
            <div className="p-8 rounded-2xl bg-white" style={{ border: '1.5px solid rgba(123,97,255,0.12)', boxShadow: '0 8px 40px rgba(123,97,255,0.08)' }}>
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <ScrollReveal key={faq.q} delay={i * 0.04}>
                <div className="p-5 rounded-2xl" style={{ border: '1px solid rgba(123,97,255,0.08)', background: '#FAFBFF' }}>
