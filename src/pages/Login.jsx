...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col"
      style={{ background: 'linear-gradient(135deg, #F5F3FF 0%, #F8F9FE 50%, #F0F1FF 100%)' }}>
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-5">
        ...
        <Link to="/signup"
          ...
          No account?{' '}
          <span className="font-bold" style={{ color: '#7B61FF' }}>Sign up →</span>
        </Link>
      </nav>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-[420px]">
          ...
          <div className="rounded-2xl p-8"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link to="/forgot-password"
                    ...
                    style={{ color: '#7B61FF' }}
                    onMouseEnter={e => e.currentTarget.style.color = '#5B3DD1'}
              ...
              <button
                ...
                style={{
                  background: loading ? 'rgba(123,97,255,0.6)' : 'linear-gradient(135deg, #7B61FF, #6C4AE8)',
                  color: '#fff',
          ...
          <p className="text-center text-xs mt-5" style={{ color: '#94A3B8' }}>
            ...
            <a href="#" style={{ color: '#7B61FF' }}>Terms</a>{' '}and{' '}
            <a href="#" style={{ color: '#7B61FF' }}>Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
