        ...
        <Link to={`/blog/${article.slug}`} className="block group">
          <div className="grid md:grid-cols-2 gap-0 rounded-3xl overflow-hidden card-lift"
            ...
            <div className="aspect-video md:aspect-auto relative overflow-hidden">
              ...
              <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(108,92,231,0.1), transparent)' }} />
            </div>
        ...
        <div className="rounded-3xl overflow-hidden card-lift h-full flex flex-col"
          ...
          <div className="aspect-video relative overflow-hidden">
            ...
            <div className="absolute top-4 left-4">
              <span className="text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full"
                style={{ background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(8px)', color: '#6C5CE7' }}>
                {article.category}
              </span>
            </div>
          </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="pt-32 pb-16 px-6 relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full blur-3xl pointer-events-none"
            style={{ background: 'radial-gradient(circle, rgba(108,92,231,0.06), transparent 70%)' }} />
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map(c => (
                <button key={c} onClick={() => setActiveCat(c)}
                  ...
                  style={{
                    background: activeCat === c ? 'linear-gradient(135deg, #6C5CE7, #7C6CF7)' : 'rgba(255,255,255,0.8)',
                    color: activeCat === c ? '#fff' : '#6B7280',
                    border: activeCat === c ? 'none' : '1px solid rgba(0,0,0,0.05)',
                    boxShadow: activeCat === c ? '0 4px 12px rgba(108,92,231,0.25)' : '0 2px 8px rgba(0,0,0,0.02)',
                  }}>
                  {c}
                </button>
              ))}
